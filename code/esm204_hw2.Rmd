...
#### Tax on water use
  ...
  - **Total cost:** The integral of the horizontally summed marginal cost of abatement curves from 0 to 255 AF abated: integral_0^255 x/1.61 dx = **$20,194.10 USD** - ***SHOULD THIS INCLUDE THE COST OF THE TAX?? NEED CLARIFICATION--if so new total would be $60,583.55??***
...
**Per district cost of abatement:** Found by taking the integral under the marginal cost abatement curves from zero to the necessary reduction in water use.
  ...
  - **Kern:** integral_0^39.72 2.29 x dx = **$1806.44 USD**
  - **Mojave:** integral_0^37.07 3.8 x dx = **$2611.23 USD**
  - **Antelope:** integral_0^58.26 2.86 x dx = **$4853.08 USD**
  - **Ventura:** integral_0^64.88 1.78 x dx = **$3745.92 USD**
