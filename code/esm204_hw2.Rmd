...
#### Tax on water use
  ...
  - **Total cost:** The integral of the horizontally summed marginal cost of abatement curves from 0 to 255 AF abated: integral_0^255 x/1.61 dx = 20,194.10 USD total cost = 20,194.10 + 40,389.45 = **60,583.55 USD**
  - **Cost per district:** First we need to find how much each district abates. We do this by finding the quantity of abatement associated with a MC_abatement of $158.39. Then we take the integral of each district's MC_abatement curve from 0 to the quantity of AF abated.
    ...
    Integral: integral_0^69.17 2.29 x dx = **5,478.24 USD**
    - **Mojave:** Q_mojave = 1/3.8 * MC_mojave --> 41.68 AF abated
    Integral: integral_0^41.68 3.8 x dx = **3,300.72 USD**
    - **Antelope:** Q_antelope = 1/2.86 * MC_antelope --> 55.38 AF abated
    Integral: integral_0^55.38 2.86 x dx = **4,385.73 USD**
    - **Ventura:** Q_ventura = 1/1.78 * MC_ventura --> 88.98 AF abated
    Integral: integral_0^88.98 1.78 x dx = **7,046.52 USD**
...
Scenarios in bold are the lowest cost outcomes for each district. Considering the entire reduction (755 AF -300 AF), Antelope and Mojave counties would prefer a single tax on water use, while Kern and Ventura counties would prefer a cap on water use without trading across districts. However, county preferences could change based on how water rights are allocated to each district. In this scenario, rights were reduced by a common fraction across all districts, but if some counties were given more water rights than others (e.g., the highest consumers were given the right to more water and did not have to purchase them) overall costs to the districts could be lower with a cap and trade scenario, due to lower costs from a reduction in overall purchasing of water rights. 

**Kern:** 
-**Cap w/o trade:** $2,943.21 USD + 1,806.44 USD = **4,749.65 USD**
-Tax: 5,478.24 USD + 3,368.56 = 8,846.80 USD
-Cap and trade: 2,552.78 USD + 2,928.82 USD = 5,481.60 USD

**Mojave:**
-Cap w/o trade: $4254.45 USD + 2,611.23 USD = 6,865.68 USD
-**Tax:** 3,300.72 USD + 2,030.41 USD = **5,331.13 USD**
-Cap and trade: 4,194.04 USD + 3,836.53 USD = 8,030.57 USD

**Antelope:**
-Cap w/o trade: 7,907.06 USD + 4,853.08 USD = 12,760.14 USD
-**Tax:** 4,385.73 USD + 2,697.22 USD = **7,082.95 USD**
-Cap and trade: 7,391.97 USD + 6,539.34 USD = 13,931.31 USD

**Ventura:** 
-**Cap w/o trade:** 6,103.17 USD + 3,745.92 USD = **9,849.09 USD**
-Tax: 7,046.52 USD + 4,334.87 USD = 11,381.39 USD
