...
#### Cap without trade
  ...
  1. Let x = the magnitude of the fraction that each district's water use will be reduced to.
  ...
  **x = 0.662**. Each district will reduce its use until current use is 0.662 of baseline use. I.e., each district will reduce its current use by a factor of 0.338.
  2. The total cost of meeting this target is found by summing the costs for each district, found in part (3) below, which equals $21,207.89 USD
  3. The cost for each district is found by taking the integral under their marginal cost abatement curve from 0 to the amount by which they reduced their use.
    A) **Kern:** integral_0^50.7 2.29 x dx = **$2943.21** USD
    B) **Mojave:** integral_0^47.32 3.8dx = **$4254.45** USD
    C) **Antelope:** integral_0^74.36 2.86 x dx = **$7907.06** USD
    D) **Ventura:** integral_0^82.81 1.78 x dx = **$6103.17** USD
  4. No tax revenue is generated because no tax is levied.
